...
| Automação do Robo para Busca Diaria | Alta 🟥 | Eu como backoffice, quero a automatização do robô, para que seja preciso apenas entrar no site e ver as novas menções. | Tem como valor a automatização do processo, assim como uma melhor experiência de uso. | 2 | ✅ |
...
🔖 SPRINT 2 ([Link da Pasta](https://github.com/whatscodeg3/API-2DSM-DailyBot)):  Concluído ✅

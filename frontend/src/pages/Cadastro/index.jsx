      ...
      <DivContainer onSubmit={handleSubmit(onSubmit)}>
        ...
        <DivDataNascEstadoCivil>
          < DivDataNasc>
            ...
            <input type="text" name="dataNascimento" placeholder="Digite sua data de nascimento" {...register("dataNascimento", { required: true })} />
          </DivDataNasc>
          <DivEstadoCivil>
        ...
        <DivRegras>
          ...
          <label for="regra" required> Eu autorizo o armazenamento destes dados no sistema *</label>
        </DivRegras>
